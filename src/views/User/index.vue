...
<template>
  <div class="user-page">
    ...
    <div class="user-page-group">
      <h3>快捷工具</h3>
      <van-cell v-for="(item, index) in tools" :key="index" :title="item.label" :to="item.path" is-link :border="false">
        <template #icon>
          <cp-icon :name="`user-tool-0${index + 1}`" style="vertical-align: middle" />
        </template>
      </van-cell>
    </div>
